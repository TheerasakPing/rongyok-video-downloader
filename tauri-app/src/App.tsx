        ...
        <div className="max-w-5xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-lg font-bold">Rongyok Downloader</h1>
                <p className="text-xs text-slate-500">
                  Video Download Manager
                  {ffmpegAvailable && (
                    <span className="ml-2 text-emerald-400">• FFmpeg ✓</span>
                  )}
        ...
        {activeTab === "download" && (
          <>
            ...
            <div className="space-y-4">
              <Input
                label="Series URL"
                placeholder="https://rongyok.com/watch/?series_id=XXX or /series/XXX/..."
                value={url}
              ...
              <Input
                ...
                rightElement={
                  <div className="flex gap-1">
                    <Button size="sm" variant="ghost" onClick={handleSelectOutputFolder}>
                      Browse
                    </Button>
                    <Button size="sm" variant="ghost" onClick={handleOpenOutputFolder}>
                      Open
                    </Button>
                  </div>
                }
                ...
                <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700 space-y-4">
                  ...
                  {mergeState.isMerging && (
                    <div className="flex items-center gap-3 p-3 bg-violet-500/20 rounded-lg border border-violet-500/30">
                      ...
                      <span className="text-violet-300 text-sm font-medium">Merging videos with FFmpeg...</span>
                    </div>
                  )}
                  {mergeState.mergedFile && !mergeState.isMerging && (
                    <div className="p-3 bg-emerald-500/20 rounded-lg border border-emerald-500/30">
                      <div className="text-emerald-300 text-sm font-medium">Merge Complete!</div>
            ...
            <div className="flex items-center gap-4">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 rounded bg-slate-700 border-slate-600 text-violet-600 focus:ring-violet-500 disabled:opacity-50"
                />
                <span className={`text-sm flex items-center gap-1 ${ffmpegAvailable ? "text-slate-300" : "text-slate-500"}`}>
                  <Merge size={14} />
            ...
            <div className="flex flex-wrap gap-3">
              {!downloadState.isDownloading ? (
                <>
                  ...
                  <Button size="lg" variant="secondary" leftIcon={<RefreshCw size={18} />} disabled>
                    Resume Previous
                  </Button>
                </>
              ) : (
                <>
                  {!downloadState.isPaused ? (
                    <Button size="lg" variant="secondary" onClick={handlePause} leftIcon={<Pause size={18} />}>
                      Pause
                    </Button>
                  ) : (
                    <Button size="lg" variant="success" onClick={handleResume} leftIcon={<Play size={18} />}>
                      Resume
                    </Button>
                  )}
                  <Button size="lg" variant="danger" onClick={handleCancel} leftIcon={<X size={18} />}>
                    Cancel
                  </Button>
                </>
              )}
